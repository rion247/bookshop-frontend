      ...
      <Container>
        ...
        <div className="my-6 md:my-8 lg:my-10 xl:my-12 font-poppins">
          ...
          <ol className="list-disc p-6 md:p-8 lg:p-10 xl:p-12">
            ...
            <li>
              <span className="font-semibold">Support Authors:</span> Provide a
              fair and inspiring space for authors to share their creativity and
          ...
          <p>
            We believe that books are the most powerful tools of transformation
            — they can educate, entertain, and enlighten all at once. Through
            eBookNest, we are nurturing a new generation of thinkers and
            storytellers.
          </p>
        </div>
          ...
          <ol className="my-6 md:my-8 lg:my-10 xl:my-12 flex flex-col gap-2 lg:gap-3 xl:gap-4">
            <li>
              <div className="flex justify-items-start items-center gap-x-2">
                <img className="w-4 h-4" src={collectionImg} alt="...Loading" />
            ...
            <li>
              ...
              <p>
                ...
                effortlessly, discover hidden gems, and enjoy smooth navigation
            ...
            <li>
              ...
              <p>
                We believe reading should be for everyone — that’s why we offer
                quality books at fair prices, with regular offers and
                recommendations.
              </p>
            </li>
            <li>
        ...
        <div className="my-6 md:my-8 lg:my-10 xl:my-12 font-poppins">
          ...
          <p>
            ...
            generations, beyond borders. A single book can open a door, spark an
            idea, or even change the course of a life.
          </p>
